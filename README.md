...
Minimal interactive C prompt. The main focus: how much mileage can we get only using a handful of Python and Bash scripts? It turns out that, when it comes to the interactive C prompt, you can kinda do it. Your computer will suffer a lot from unnecessary and repetitive computations, but at least _you_ can do your job.
